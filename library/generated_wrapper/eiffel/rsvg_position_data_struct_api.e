...
class RSVG_POSITION_DATA_STRUCT_API
...
feature {NONE} -- Implementation wrapper for struct struct _RsvgPositionData

	sizeof_external: INTEGER 
		external
			"C inline use <rsvg.h>"
		alias
			"sizeof(struct _RsvgPositionData)"
		end
	...
	c_x (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct _RsvgPositionData*)$an_item)->x
			]"
		end
	...
	set_c_x (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct _RsvgPositionData*)$an_item)->x =  (int)$a_value
			]"
		ensure
	...
	c_y (an_item: POINTER): INTEGER
		...
		alias
			"[
				((struct _RsvgPositionData*)$an_item)->y
			]"
		end
	...
	set_c_y (an_item: POINTER; a_value: INTEGER) 
		...
		alias
			"[
				((struct _RsvgPositionData*)$an_item)->y =  (int)$a_value
			]"
		ensure
